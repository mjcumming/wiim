...
@pytest.fixture
def mock_group_master(mock_master_player):
...
@pytest.fixture
def mock_group_master_setup(mock_group_master, mock_config_entry):
    """Set up mock_group_master with player properties."""
    # Set up player properties
    mock_group_master.player.name = "Test WiiM"
    mock_group_master.player.model = "WiiM Mini"
    mock_group_master.player.firmware = "1.0.0"
    mock_group_master.player.host = "192.168.1.100"
    mock_group_master.player.device_info = MagicMock()
    mock_group_master.player.device_info.mac = "AA:BB:CC:DD:EE:FF"
    mock_group_master.player.input_list = ["spotify", "bluetooth"]
    ...
    return CoordinatorSetup(mock_group_master, mock_config_entry)


@pytest.fixture
def group_media_player(mock_group_master, mock_config_entry):
    ...
    mock_group_master.player.device_info.mac = "AA:BB:CC:DD:EE:FF"
    mock_group_master.player.input_list = ["spotify", "bluetooth"]
    return WiiMGroupMediaPlayer(mock_group_master, mock_config_entry)
...
class TestWiiMGroupMediaPlayerVolume:
    ...
    def test_volume_level_returns_group_max(self, mock_group_master_setup, mock_master_player):
    ...
    async def test_set_volume_level_handles_error(self, mock_group_master_setup, mock_master_player):
...
class TestWiiMGroupMediaPlayerMute:
    ...
    def test_is_volume_muted_returns_true_when_all_muted(self, mock_group_master_setup, mock_master_player):
...
class TestWiiMGroupMediaPlayerPlayback:
    ...
    async def test_playback_handles_other_errors(self, mock_group_master_setup, mock_master_player):
...
class TestWiiMGroupMediaPlayerState:
    ...
    def test_state_playing(self, mock_group_master_setup, mock_master_player):
...
class TestWiiMGroupMediaPlayerMediaInfo:
    ...
    def test_media_duration(self, mock_group_master_setup, mock_master_player):
    ...
    def test_media_position(self, mock_group_master_setup, mock_master_player):
...
class TestWiiMGroupMediaPlayerShuffleRepeat:
    ...
    @pytest.mark.asyncio
    async def test_set_repeat_all(self, mock_group_master_setup, mock_master_player):
    ...
    @pytest.mark.asyncio
    async def test_set_repeat_handles_error(self, mock_group_master_setup, mock_master_player):
...
class TestWiiMGroupMediaPlayerMediaContent:
    ...
    def test_media_content_type(self, mock_group_master_setup):
    ...
    def test_media_content_id_returns_none_when_idle(self, mock_group_master_setup, mock_master_player):
...
class TestWiiMGroupMediaPlayerImageHandling:
    ...
    @pytest.mark.asyncio
    async def test_get_media_image_returns_cover_art(self, mock_group_master_setup, mock_master_player):
    ...
    @pytest.mark.asyncio
    async def test_get_media_image_handles_exception(self, mock_group_master_setup, mock_master_player):
...
class TestWiiMGroupMediaPlayerStateEdgeCases:
    ...
    def test_state_derives_playing_from_is_playing(self, mock_group_master_setup, mock_master_player):
    ...
    def test_state_derives_buffering_from_is_buffering(self, mock_group_master_setup, mock_master_player):
    ...
    def test_state_uses_attr_state_when_set(self, mock_group_master_setup):
...
class TestWiiMGroupMediaPlayerHandleUpdate:
    ...
    def test_handle_coordinator_update_updates_position(self, mock_group_master_setup, mock_master_player):
...
class TestWiiMGroupMediaPlayerRoleTransitions:
    ...
    def test_role_transition_solo_to_master(self, mock_group_master_setup, mock_master_player):
        """Test entity handles transition from solo to master."""
        coordinator = mock_group_master_setup.coordinator
        coordinator.data = {"player": mock_master_player}
        entity = WiiMGroupMediaPlayer(coordinator, mock_group_master_setup.config_entry)
    ...
    def test_group_slaves_populated_to_empty(self, mock_group_master_setup, mock_master_player):
