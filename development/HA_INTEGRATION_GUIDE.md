...
_Last reviewed against upstream on 2026-06-05 (pywiim 2.2.8: `validate_device_strict()` adds exception-style validation for manual setup flows; `validate_device()` remains soft-fail for discovery scans)._
